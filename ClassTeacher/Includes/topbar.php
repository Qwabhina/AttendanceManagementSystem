...
?>
<nav class="navbar navbar-expand navbar-light topbar bg-primary mb-4 static-top">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labeledby="userDropdown">
